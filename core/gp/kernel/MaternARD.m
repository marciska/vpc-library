function kernel = MaternARD(x1, x2, hyp, p) %#codegen
...
%   r = √{Σ_i=1^n ((x1-x2)/l_i)²} with l_i the lengthscale. Both σ and l
%   are hyperparameters. p can be given by the function call, whereas if it
%   was not given then the default value is p = 2.
%
% -----------
%
% Inputs:
